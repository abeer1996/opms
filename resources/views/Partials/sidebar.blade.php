    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item" href="{{route('employee.list')}}"><i class="icon fa fa-circle-o"></i>Employee Registration</a></li>
                <li><a class="treeview-item" href="{{route('manager.list')}}"><i class="icon fa fa-circle-o"></i>Manager Registration</a></li>
            </ul>
        </li>

        <li><a class="app-menu__item" href="{{route('department.list')}}"><i class="app-menu__icon fa fa-pie-chart"></i><span
                    class="app-menu__label">Department Info</span></a></li>
